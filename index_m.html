<html>
    ...
    <section>
            <table>
                <tr>
                    <td> <p> <a class="two" href=""> Персонажі </a></p> </td>
                    <td> <p> <a class="three" href=""> Зброя </a></p> </td>
                </tr>
            </table>
        </section> 
            <article>
    ...
    <footer>
        <section>
            ...
            <article>
                <iframe width="70%" height="70%" src="https://www.youtube.com/embed/iPawkHfB9Gk" title="YouTube video player" frameborder="0"></iframe>
            </article>
            <article class="article1">
    <img class="img1" src="https://drive.google.com/uc?export=veiw&id=1eQ13OIsa9RjUf5JBZnz2cDIDCAjJd21m">
    <p class="text1">
        <a href="https://genshin.hoyoverse.com/en/"> де скачати</a>
    </p>
            </article>
            <article class="article2">
    <img class="img2" src="https://drive.google.com/uc?export=veiw&id=1o1cE3p1qPYO9GC6-RDH-X72qkhS5bX49">
    <p class="text2">
        <a href="https://genshin.hoyoverse.com/en/home"> офіціальний сайт</a>
    </p>
            </article>
