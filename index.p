<html>
    ...
    <body>
        <header>
                ...
                <nav>
                    <a class="first" href="">Головна</a>
                    <a class="second" href="">Зброя</a>
                </nav>
                <section>
                        <article>
                <p class="p1">
        ...
        <footer>
                ...
                <img class="image1" src="https://drive.google.com/uc?export=veiw&id=1eQ13OIsa9RjUf5JBZnz2cDIDCAjJd21m">
                <p class="texte1">
                    <a href="https://genshin.hoyoverse.com/en/"> де скачати</a>
                </p>
                        </article>
                        <article class="articl2">
                <img class="image2" src="https://drive.google.com/uc?export=veiw&id=1o1cE3p1qPYO9GC6-RDH-X72qkhS5bX49">
                <p class="texte2">
                    <a href="https://genshin.hoyoverse.com/en/home"> офіційний сайт</a>
                </p>
                        </article>
